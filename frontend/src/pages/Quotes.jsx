...
/** Board columns — all workflow columns */
...
export default function Quotes() {
  ...
  const handleSendForSignature = async (id, e) => {
    ...
    try {
      ...
      setQuotes(prev => prev.map(q => q._id === id ? (res.data?.quote || { ...q, status: 'Sent for Signature', documentUrl: res.data?.documentUrl, pdfUrl: res.data?.pdfUrl }) : q));
      showToast('Template copied, placeholders replaced in Google Docs, and sent via BoldSign!');
    } catch (err) {
      ...
      <div className="quotes-header-row">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <button
            ...
            title={loading ? 'Syncing latest BoldSign statuses...' : 'Refresh documents and sync BoldSign status'}
            style={{
              padding: '0.75rem',
              borderRadius: '50%',
                        ...
                        <div style={{ display: 'flex', gap: '0.4rem', alignItems: 'center' }}>
                          {q.documentUrl ? (
                            <a
                              ...
                              title="Open Google Doc Agreement"
                            >
                          ...
                          {q.pdfUrl ? (
                            <a
                              ...
                              style={{
                                padding: '0.25rem 0.5rem',
                                borderRadius: '0.375rem',
                                background: (s === 'Customer Signed' || s === 'Signed' || s === 'Completed') ? '#f0fdf4' : '#fef2f2',
                                color: (s === 'Customer Signed' || s === 'Signed' || s === 'Completed') ? '#15803d' : '#dc2626',
                                border: (s === 'Customer Signed' || s === 'Signed' || s === 'Completed') ? '1px solid #86efac' : '1px solid #fecaca',
                                fontSize: '0.75rem',
                                fontWeight: 700,
                                display: 'inline-flex',
                                alignItems: 'center',
                            ...
                            >
                              {(s === 'Customer Signed' || s === 'Signed' || s === 'Completed') ? (
                                <>
            ...
            return (
              ...
              >
                ...
                <div className="kanban-col-header-row">
                  <h3 className="kanban-col-title" style={{ color: 'var(--text-primary)', letterSpacing: '0.05em' }}>{col}</h3>
                  <span 
